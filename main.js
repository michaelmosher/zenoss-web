...
var _michaelmosher$zenoss_web$Zenoss$eventDecoder = A9(
	_elm_lang$core$Json_Decode$map8,
	_michaelmosher$zenoss_web$Main_Model$Event,
	...
	A2(_elm_lang$core$Json_Decode$field, 'prodState', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'severity', _michaelmosher$zenoss_web$Zenoss$severityDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'eventState', _michaelmosher$zenoss_web$Zenoss$eventStateDecoder),
	A2(
		_elm_lang$core$Json_Decode$field,
		'ownerid',
...
var _michaelmosher$zenoss_web$Zenoss_Html$renderEvent = function (event) {
	var bgColor = function () {
		var _p4 = event.eventState;
		if (_p4.ctor === 'New') {
			return 'white';
		} else {
			return 'lightgrey';
...
var _michaelmosher$zenoss_web$Zenoss_Html$renderEventList = function (events) {
	...
	return A2(
		...
		A2(_elm_lang$core$List$map, _michaelmosher$zenoss_web$Zenoss_Html$renderEvent, events));
};
			...
			default:
				if (_p1._0.ctor === 'Ok') {
					...
					var loginFailed = A8(
						...
						'Production',
						'Critical',
						_michaelmosher$zenoss_web$Main_Model$New,
						_elm_lang$core$Maybe$Nothing,
						1);
					return {
						ctor: '_Tuple2',
