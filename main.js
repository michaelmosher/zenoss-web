							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('easily modify device production state'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _michaelmosher$zenoss_web$Main_Model$Event = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {id: a, deviceName: b, summary: c, prodState: d, severity: e, eventState: f, owner: g, count: h, firstTime: i, lastTime: j, component: k, stdErr: l};
											};
										};
									};
								};
...
var _michaelmosher$zenoss_web$Main_Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {currentPage: a, hostname: b, username: c, password: d, devices: e, events: f};
	});
...
var _michaelmosher$zenoss_web$Main_Model$RefreshDevices = {ctor: 'RefreshDevices'};
...
var _michaelmosher$zenoss_web$Main_Model$AcknowledgeEvent = function (a) {
	return {ctor: 'AcknowledgeEvent', _0: a};
};
...
var _michaelmosher$zenoss_web$Main_Model$UpdateUsername = function (a) {
	...
	var refreshAction = function () {
		...
		do {
			if (_p0.ctor === 'Just') {
				switch (_p0._0.ctor) {
					case 'DevicesPage':
						return _elm_lang$core$Maybe$Just(_michaelmosher$zenoss_web$Main_Model$RefreshDevices);
					case 'EventsPage':
...
var _michaelmosher$zenoss_web$Zenoss_Http_Devices$deviceProdStateDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function ($int) {
		var _p0 = $int;
		switch (_p0) {
			case 1000:
				return _elm_lang$core$Json_Decode$succeed('Production');
			case 500:
				return _elm_lang$core$Json_Decode$succeed('Pre-Production');
			case 400:
				return _elm_lang$core$Json_Decode$succeed('Test');
			case 300:
				return _elm_lang$core$Json_Decode$succeed('Maintenance');
			case -1:
				return _elm_lang$core$Json_Decode$succeed('Decommissioned');
			default:
				return _elm_lang$core$Json_Decode$succeed(
					A2(
						_elm_lang$core$Basics_ops['++'],
		...
		_0: _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						{
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$string('uid'),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$string('events'),
												_1: {ctor: '[]'}
											}
										}
									}
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'uid',
							_1: _elm_lang$core$Json_Encode$string('/zport/dmd/Devices/Server')
						},
						_1: {ctor: '[]'}
					}
				}
...
var _michaelmosher$zenoss_web$Zenoss_Http_Events$eventStateDecoder = A2(
	...
	function (str) {
		...
		switch (_p0) {
			case 'New':
				return _elm_lang$core$Json_Decode$succeed(_michaelmosher$zenoss_web$Main_Model$New);
			case 'Acknowledged':
				return _elm_lang$core$Json_Decode$succeed(_michaelmosher$zenoss_web$Main_Model$Acknowledged);
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Uknown EventState: ', _p0));
		}
	},
	_elm_lang$core$Json_Decode$string);
var _michaelmosher$zenoss_web$Zenoss_Http_Events$severityDecoder = A2(
	...
	function (num) {
		...
		switch (_p1) {
			case 5:
				return _elm_lang$core$Json_Decode$succeed('Critical');
			case 4:
				return _elm_lang$core$Json_Decode$succeed('Error');
			case 3:
				return _elm_lang$core$Json_Decode$succeed('Warning');
			case 2:
				return _elm_lang$core$Json_Decode$succeed('Info');
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(
						_elm_lang$core$Basics_ops['++'],
			...
			_0: _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							{
								ctor: '::',
								_0: _elm_lang$core$Json_Encode$string(eventId),
								_1: {ctor: '[]'}
							})
					},
					_1: {ctor: '[]'}
...
var _michaelmosher$zenoss_web$Zenoss_Html$countAlerts = function (d) {
	return (d.critEvents + d.errEvents) + d.warnEvents;
};
...
var _michaelmosher$zenoss_web$Zenoss_Html$severityShape = function (s) {
	var _p0 = s;
	switch (_p0) {
		case 'Critical':
			return A2(
				_elm_lang$svg$Svg$polygon,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$points('11,5 19,5 25,11 25,19 19,25 11,25 5,19 5,11'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'});
		case 'Error':
			return A2(
				_elm_lang$svg$Svg$polygon,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$points('5,5 15,25 25,5'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'});
		case 'Warning':
			return A2(
				_elm_lang$svg$Svg$polygon,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$points('15,5 5,25 25,25'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'});
...
var _michaelmosher$zenoss_web$Zenoss_Html$eventStateString = function (e) {
	var _p1 = e;
	if (_p1.ctor === 'New') {
		return _elm_lang$core$String$fromChar(
			_elm_lang$core$Char$fromCode(9675));
	} else {
		return _elm_lang$core$String$fromChar(
...
var _michaelmosher$zenoss_web$Zenoss_Html$renderEventState = function (s) {
	...
	return A2(
		...
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				_michaelmosher$zenoss_web$Zenoss_Html$eventStateString(s)),
			_1: {ctor: '[]'}
		});
};
var _michaelmosher$zenoss_web$Zenoss_Html$renderEventOwner = function (owner) {
	var ownerString = function () {
		var _p3 = owner;
		if (_p3.ctor === 'Nothing') {
			return 'Not ack\'d';
		} else {
			return A2(_elm_lang$core$Basics_ops['++'], 'Ack\'d by ', _p3._0);
		}
	}();
	return A2(
		_elm_lang$html$Html$span,
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(ownerString),
			_1: {ctor: '[]'}
		});
};
var _michaelmosher$zenoss_web$Zenoss_Html$renderEventCount = function (c) {
	var css = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'flex-grow', _1: '1'},
...
var _michaelmosher$zenoss_web$Zenoss_Html$renderEventSeverity = function (s) {
	var svgAttrs = {
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$style(
			{
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _michaelmosher$zenoss_web$Zenoss_Html$severityShape(s),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _michaelmosher$zenoss_web$Zenoss_Html$renderDetailedEvent = function (event) {
	var ownerString = function () {
		var _p4 = event.owner;
		if (_p4.ctor === 'Nothing') {
			return 'Not ack\'d';
		} else {
			return A2(_elm_lang$core$Basics_ops['++'], 'Ack\'d by ', _p4._0);
		}
	}();
	var component = function () {
		var _p5 = event.component;
		if (_p5.ctor === 'Just') {
			return _p5._0;
		} else {
			return 'null';
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'device', event.deviceName),
			_1: {
				ctor: '::',
				_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'component', component),
				_1: {
					ctor: '::',
					_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'summary', event.summary),
					_1: {
						ctor: '::',
						_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'prod state', event.prodState),
						_1: {
							ctor: '::',
							_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'severity', event.severity),
							_1: {
								ctor: '::',
								_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'owner', ownerString),
								_1: {
									ctor: '::',
									_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'first occurance', event.firstTime),
									_1: {
										ctor: '::',
										_0: A2(_michaelmosher$zenoss_web$Zenoss_Html$eventDetailField, 'latest occurance', event.lastTime),
										_1: {
											ctor: '::',
...
var _michaelmosher$zenoss_web$Zenoss_Html$renderSimpleEvent = function (event) {
	var bgColor = function () {
		var _p6 = event.eventState;
		if (_p6.ctor === 'New') {
			return 'white';
		} else {
			return 'lightgrey';
	...
	var mainCss = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventSeverity(event.severity),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventDeviceName(event.deviceName),
								_1: {
									ctor: '::',
									_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventProdState(event.prodState),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							ctor: '::',
							_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventSummary(event.summary),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									...
									{
										ctor: '::',
										_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventCount(event.count),
										_1: {
											ctor: '::',
											_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventOwner(event.owner),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
				...
				_1: {
					ctor: '::',
					_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventState(event.eventState),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventDeviceName(d.name),
					_1: {
						ctor: '::',
						_0: _michaelmosher$zenoss_web$Zenoss_Html$renderEventProdState(d.prodState),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(d.ipAddress),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
									...
									_elm_lang$html$Html$text(
										A2(
											...
											_elm_lang$core$Basics$toString(
												_michaelmosher$zenoss_web$Zenoss_Html$countAlerts(d)))))),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _michaelmosher$zenoss_web$Zenoss_Html$renderDeviceList = function (devices) {
	var partedDevices = A2(
		...
		A2(
			_elm_lang$core$List$filter,
			function (d) {
				return !_elm_lang$core$Native_Utils.eq(d.prodState, 'Decommissioned');
			},
			devices));
	var sortedDevices = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Tuple$first(partedDevices),
		_elm_lang$core$Tuple$second(partedDevices));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _michaelmosher$zenoss_web$Zenoss_Html$renderDeviceSummary, sortedDevices));
};

var _michaelmosher$zenoss_web$Zenoss$errorEvent = function (err) {
	return _michaelmosher$zenoss_web$Main_Model$Event('error')('zenoss-web')(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Failed to connect to Zenoss server: ',
			_elm_lang$core$Basics$toString(err)))('Production')('Critical')(_michaelmosher$zenoss_web$Main_Model$New)(_elm_lang$core$Maybe$Nothing)(1)('null')('null')(_elm_lang$core$Maybe$Nothing)('N/A');
};
var _michaelmosher$zenoss_web$Zenoss$eventDetailView = F2(
	function (model, eid) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
...
var _michaelmosher$zenoss_web$Zenoss$devicesView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _michaelmosher$zenoss_web$Zenoss_Html$renderDeviceList(model.devices),
			_1: {ctor: '[]'}
		});
};
			...
			function (event) {
				if (_elm_lang$core$Native_Utils.eq(event.id, eventId)) {
					...
					if (_p0.ctor === 'New') {
						...
						return _elm_lang$core$Native_Utils.update(
							event,
							{eventState: _michaelmosher$zenoss_web$Main_Model$New});
					}
				} else {
					return event;
				}
...
var _michaelmosher$zenoss_web$Zenoss$refreshDevices = function (model) {
	var request = _michaelmosher$zenoss_web$Zenoss_Http_Devices$get(
		{hostname: model.hostname, username: model.username, password: model.password});
	var responseHandler = _michaelmosher$zenoss_web$Main_Model$NewDevices;
	return A2(_elm_lang$http$Http$send, responseHandler, request);
};
		...
		switch (_p0._0.ctor) {
			...
			case 'DevicesPage':
				return A2(
					...
					{
						ctor: '::',
						_0: _michaelmosher$zenoss_web$Zenoss$devicesView(model),
						_1: {ctor: '[]'}
					},
					model.currentPage);
			case 'DevicePage':
		...
		switch (_p1.ctor) {
			case 'UrlChange':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentPage: A2(_evancz$url_parser$UrlParser$parseHash, _michaelmosher$zenoss_web$Main$route, _p1._0)
						}),
			...
			case 'NewEvents':
				if (_p1._0.ctor === 'Ok') {
					...
					var loginFailed = _michaelmosher$zenoss_web$Zenoss$errorEvent(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Failed to connect to Zenoss server: ',
			...
			case 'RefreshDevices':
				return A2(
					...
					model,
					{
						...
						_1: {
							ctor: '::',
							_0: _michaelmosher$zenoss_web$Zenoss$refreshDevices(model),
							_1: {ctor: '[]'}
						}
					});
			case 'NewDevices':
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _michaelmosher$zenoss_web$Main$main !== 'undefined') {
    _michaelmosher$zenoss_web$Main$main(Elm['Main'], 'Main', undefined);
}
